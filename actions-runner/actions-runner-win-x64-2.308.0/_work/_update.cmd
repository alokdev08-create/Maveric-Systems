...
set rootfolder=C:\Users\Alok\Downloads\Maveric Systems\Maveric-Systems\actions-runner\actions-runner-win-x64-2.308.0
set existrunnerversion=2.308.0
set downloadrunnerversion=2.328.0
set logfile=C:\Users\Alok\Downloads\Maveric Systems\Maveric-Systems\actions-runner\actions-runner-win-x64-2.308.0\_diag\SelfUpdate-20250921-122600.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\Alok\Downloads\Maveric Systems\Maveric-Systems\actions-runner\actions-runner-win-x64-2.308.0\run.cmd"
) else (
  endlocal
)
